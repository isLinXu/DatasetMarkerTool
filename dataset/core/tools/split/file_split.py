...
def file_splitss():
    dataset_path = '/home/data/323/'
    train_dir = '/home/data/323/smoke_coco/train/'
    test_dir = '/home/data/323/smoke_coco/val/'
    datase_smoke_path = '/home/data/323/smoke_coco/'
    # 类标签列表
    labelList = []
    fileList = []
    typeList = []
    ...
    # check-dir
    check_dir(datase_smoke_path)
    check_dir(train_dir)
    check_dir(test_dir)
    # datasetList.remove('smoke_coco')
    print(datasetList)
    # 文件夹中文件数量

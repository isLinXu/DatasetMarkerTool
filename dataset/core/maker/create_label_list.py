...
if __name__ == '__main__':
    root_dir = '/media/hxzh02/SB@home/hxzh/PaddleDetection_YOLOSeries/dataset/COCO_PeiDian/'
    xml_dir = '/media/hxzh02/SB@home/hxzh/PaddleDetection_YOLOSeries/dataset/COCO_PeiDian/Annotations'  # 标签文件地址
    img_dir = '/media/hxzh02/SB@home/hxzh/PaddleDetection_YOLOSeries/dataset/COCO_PeiDian/JPEGImages'  # 图像文件地址
    train_xml_dir = root_dir + 'train.txt'
    val_xml_dir = root_dir + '/val.txt'
    train_img_dir = root_dir + 'train'
    val_img_dir = root_dir + 'val'
    ratio = 0.9
    label_dir = root_dir + 'label_list.txt'

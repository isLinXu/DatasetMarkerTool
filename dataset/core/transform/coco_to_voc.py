...
CKimg_dir = '/home/hxzh02/文档/DeepLabV3Plus-Pytorch/datasets/data/VOCdevkit/VOC2021/images'
CKanno_dir = '/home/hxzh02/文档/DeepLabV3Plus-Pytorch/datasets/data/VOCdevkit/VOC2021/annotations'
...
def main():
    # step1 这里是一个新的文件夹，存放转换后的图片和标注
    base_dir = '/home/hxzh02/文档/DeepLabV3Plus-Pytorch/datasets/data/VOCdevkit/VOC2021'
    # 在上述文件夹中生成images，annotations两个子文件夹
    image_dir = os.path.join(base_dir, 'images')
    anno_dir = os.path.join(base_dir, 'annotations')
    mkr(image_dir)
    mkr(anno_dir)
    # step 2原始的coco的图像存放位置
    # origin_image_dir = '/home/jerry/data/data/object_detect/coco2017/images'
    origin_image_dir = '/media/hxzh02/SB@home/hxzh/Dataset/PPLTA航拍输电线路数据集/data_original_size/images'
    # step 3 原始的coco的标注存放位置
    # origin_anno_dir = '/home/jerry/data/data/object_detect/coco2017/annotations'
    origin_anno_dir = '/media/hxzh02/SB@home/hxzh/Dataset/PPLTA航拍输电线路数据集/data_original_size/annotations'
    # 是否需要看下标记是否正确的开关标记，若是true,就会把标记展示到图片上
    verbose = True
